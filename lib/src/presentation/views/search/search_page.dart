...
class SearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<SearchInfoCubit>(
                ...
                onTap: () {
                  if (_textEditingController.text.isNotEmpty) {
                    BlocProvider.of<SearchInfoCubit>(context)
                        .searchResult(_textEditingController.text,context);
                  }
                },
                child: Container(
                  height: 60,
                  ...
                  child: BlocConsumer<SearchInfoCubit,SearchInfoState>(
                    listener:(context,state){
                      if(state.searchInfoStatus!.isInitial)
                        showAlertDialog(context,content:"No city found with this name.");
                    },
                    builder:(context,state){
                      if(state.searchInfoStatus!.isLoading){
                        return Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children:[
                            Text("Loading",style: Theme.of(context)
                                .textTheme
                                .headline5!
                      ...
                      else if(state.searchInfoStatus!.isSuccess){
                        return Center(
                            child: Text(
                              "Search",
                              style: Theme.of(context)
